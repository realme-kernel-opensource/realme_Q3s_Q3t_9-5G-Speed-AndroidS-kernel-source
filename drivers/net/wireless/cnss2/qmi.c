...
//WuGuotian@CONNECTIVITY.WIFI.HARDWARE.BDF.1065227 , 2021/05/26,
...
#if IS_ENABLED(CONFIG_OPLUS_FEATURE_WIFI_BDF)
//WuGuotian@CONNECTIVITY.WIFI.HARDWARE.BDF.1065227 , 2021/05/26, Modify for: multi projects using different bdf
request_bdf:
...
//WuGuotian@CONNECTIVITY.WIFI.HARDWARE.MAC.1068489, 2021/05/27, revert for factory write mac address order: write from mac_address[5] to mac_address[0],so mac address[5] is first
	int i;
