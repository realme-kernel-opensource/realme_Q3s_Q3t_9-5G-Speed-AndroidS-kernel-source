...
extern int oplus_chg_show_warp_logo_ornot(void);
...
extern bool oplus_warp_check_chip_is_null(void);
...
static int oplus_charger_probe(struct platform_device *pdev)
{
        ...
        ret = oplus_chg_parse_swarp_dt(oplus_chip);
...
/*move from oplus_mtk_charger.c end*/
        ...
        /*keep "Ibus < 200mA" for 1s, so warp/swarp adapter go into idle and release D+*/
